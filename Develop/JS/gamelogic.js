...
var questions = [{
    ...
    question: "The recipe: 2 oz London Dry Gin, 1 oz Lemon Juice, 3/4 oz simple syrup, build in a highball glass with ice, stir, top off with club soda and garnish with lemon slice",
	...
	question: "'Three measures of Gordon's, one of vodka, half a measure of Kina Lillet. Shake it very well unitl it's ice-cold, then add a large, thin slice of lemon peel.'-JB",
    answers: ["Celine Fizz", "Strange Brew", "Martini", "Vesper"],
    correctAnswer: 3
    // Correct answer: Vesper
}, {
	question: "The recipe: 1.5 oz of London Dry Gin, 1/2 oz orange liqueur, 3/4 oz lime juice, 1 tsp grenadine, shake with ice and strain into a cocktail glass",
